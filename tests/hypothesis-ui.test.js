...
test('simple English hierarchy keeps secondary controls and evidence closed, risk visible',()=>{
 ...
 assert.match(html,/CLICK A FLY TO SEE ITS STORY/);assert.match(html,/<details><summary>Full details · strategy and trades/);assert.doesNotMatch(html,/<pre id="raw-evidence"/);
